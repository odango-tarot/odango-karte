...
- JSONではなく、そのままコピペして使えるプレーンテキストで出力する
- 記号や見出しは「一目でわかる」ことを優先して臨機応変に使う

【構成の目安】
1. 【ご相談内容】— 相談テーマを箇条書き
2. 【鑑定の核心】— テーマごとに小見出し（■）を立て、占いで見えた事実・相性・時期を整理。
   重要なポイントには → でひとこと補足を添える
3. 【アドバイス】— 相談者への行動指針・心がけを箇条書き
4. 【キーワード】— 重要な人物名・時期・固有名詞をコンパクトに
5. 【次回フォロー】— 次回確認・引き継ぎ事項を箇条書き
